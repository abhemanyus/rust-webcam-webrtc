...
pub async fn create_peer_connection(config: IceConfig) -> Result<RTCPeerConnection, Error> {
...
async fn handle_holler(peer_connection: &RTCPeerConnection, payload: Payload) -> Option<Payload> {
